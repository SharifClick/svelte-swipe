<script>
  ...
  const noSupportPassive = { passive: false };
  ...
  function eventDelegate(type) {
    ...
    if (typeof window !== "undefined") {
      window[delegationTypes[type]]("mousemove", onMove, noSupportPassive);
      window[delegationTypes[type]]("mouseup", onEnd, noSupportPassive);
      window[delegationTypes[type]]("touchmove", onMove, noSupportPassive);
      window[delegationTypes[type]]("touchend", onEnd, noSupportPassive);
    }
  }
